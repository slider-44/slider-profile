...
angular.module('siTable.directives').directive('sortBy', ['$rootScope', function($rootScope) {
  return {
	...
	<span class="sort-caret sort-asc fa fa-sort"\
    ng-if="state !== \'desc\' && state !== \'asc\'"></span>\
    <span class="sort-caret sort-asc fa fa-sort-asc"\
    ng-if="state === \'desc\'"></span>\
    <span class="sort-caret sort-desc fa fa-sort-desc"\
